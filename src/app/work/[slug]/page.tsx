...
const SingleWorkPost = ( { params }: Props ) => {
  const post = getPostBySlug( SlugOptions.WORK, params.slug )
...
export function generateStaticParams() {
  const posts = getAllPosts( SlugOptions.WORK )
