...
I'm currently available for hire, but you probably know that. Let's get in <Link href="/contact">contact</Link> and start a conversation.
...
A little more info below and in the <Link href="/codex">codex</Link>.
