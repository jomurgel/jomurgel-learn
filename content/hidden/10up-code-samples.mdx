...
- While there's some work for automated Testing using Jest and the [React Native Testing Library](https://github.com/callstack/react-native-testing-library)
I wasn't able to work through the large marjority of those areas before I hit my self-imposed deadline. This is definitily
something I plan on completing as this gets closer to a final product.

<video controls autoplay loop style={{maxWidth: 300}} data-align="center">
